#ifndef _STMP_BCH_H
#define _STMP_BCH_H  1

//#include "regs.h"

#ifndef REGS_BCH_BASE
#define REGS_BCH_BASE (0x80000000 + 0x0000A000)
#endif
...
#define HW_BCH_CTRL_SET(v)    ((*(volatile unsigned int *) HW_BCH_CTRL_SET_ADDR) = (v))
#define HW_BCH_CTRL_CLR(v)    ((*(volatile unsigned int *) HW_BCH_CTRL_CLR_ADDR) = (v))
#define HW_BCH_CTRL_TOG(v)    ((*(volatile unsigned int *) HW_BCH_CTRL_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_CTRL_SFTRST(v)   ((((unsigned int) v) << 31) & BM_BCH_CTRL_SFTRST)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_STATUS0_HANDLE(v)   ((((unsigned int) v) << 20) & BM_BCH_STATUS0_HANDLE)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_ENCODEPTR_ADDR(v)   ((unsigned int) v)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_DATAPTR_ADDR(v)   ((unsigned int) v)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_METAPTR_ADDR(v)   ((unsigned int) v)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_LAYOUTSELECT_CS15_SELECT(v)   ((((unsigned int) v) << 30) & BM_BCH_LAYOUTSELECT_CS15_SELECT)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_FLASH0LAYOUT0_NBLOCKS(v)   ((((unsigned int) v) << 24) & BM_BCH_FLASH0LAYOUT0_NBLOCKS)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_FLASH0LAYOUT1_PAGE_SIZE(v)   ((((unsigned int) v) << 16) & BM_BCH_FLASH0LAYOUT1_PAGE_SIZE)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_FLASH1LAYOUT1_PAGE_SIZE(v)   ((((unsigned int) v) << 16) & BM_BCH_FLASH1LAYOUT1_PAGE_SIZE)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_FLASH2LAYOUT0_NBLOCKS(v)   ((((unsigned int) v) << 24) & BM_BCH_FLASH2LAYOUT0_NBLOCKS)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_FLASH2LAYOUT1_PAGE_SIZE(v)   ((((unsigned int) v) << 16) & BM_BCH_FLASH2LAYOUT1_PAGE_SIZE)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_FLASH3LAYOUT0_NBLOCKS(v)   ((((unsigned int) v) << 24) & BM_BCH_FLASH3LAYOUT0_NBLOCKS)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_FLASH3LAYOUT1_PAGE_SIZE(v)   ((((unsigned int) v) << 16) & BM_BCH_FLASH3LAYOUT1_PAGE_SIZE)
#else
...
#define HW_BCH_DEBUG0_SET(v)    ((*(volatile unsigned int *) HW_BCH_DEBUG0_SET_ADDR) = (v))
#define HW_BCH_DEBUG0_CLR(v)    ((*(volatile unsigned int *) HW_BCH_DEBUG0_CLR_ADDR) = (v))
#define HW_BCH_DEBUG0_TOG(v)    ((*(volatile unsigned int *) HW_BCH_DEBUG0_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_DBGKESREAD_VALUES(v)   ((unsigned int) v)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_DBGCSFEREAD_VALUES(v)   ((unsigned int) v)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_DBGSYNDGENREAD_VALUES(v)   ((unsigned int) v)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_DBGAHBMREAD_VALUES(v)   ((unsigned int) v)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_BLOCKNAME_NAME(v)   ((unsigned int) v)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_BCH_VERSION_MAJOR(v)   ((((unsigned int) v) << 24) & BM_BCH_VERSION_MAJOR)
#else
